    ...
    <div className={styles.overlay}>
      <div className={styles.modal}>
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          <label>
            Type of Visa:
            <input type="text" name="visaType" onChange={handleChange} />
          </label>
          <label>
            Hotel Required?
            <select name="hotelRequired" onChange={handleChange}>
              <option value="No">No</option>
              <option value="Yes">Yes</option>
            </select>
          </label>
          <label>
            Tour Package or UMRAH (on way):
            <input type="text" name="tourType" onChange={handleChange} />
          </label>
          <label>
            Transport Required?
            <select name="transportRequired" onChange={handleChange}>
              <option value="No">No</option>
              <option value="Yes">Yes</option>
            </select>
          </label>
